...
React.createElement("div", { className: "tag", style: { '--color': color } }, React.createElement("span", null, "#"), " ", text);

const App = () => 
React.createElement("div", { className: "app" },
React.createElement("header", null,
React.createElement("h1", null, "Infinite Scroll Animation"),
React.createElement("p", null, "CSS only, content independent, bi-directional, customizable")),
